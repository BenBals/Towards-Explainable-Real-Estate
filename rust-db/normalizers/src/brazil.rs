...
#[derive(Clone, Debug)]
/// A simple Normalizer for Brazil Data
/// It has one factor for whole Brazil for every quarter in \[2001, 2020\]
pub struct BrazilNormalizer {
    quarters: HashMap<Quarter, QuarterFactor>,
}

impl BrazilNormalizer {
    /// Uses Data from https://fred.stlouisfed.org/series/QBRN628BIS/
    pub fn new() -> Self {
        let path =
            path_or_relative_to_project_root(None, "./data/normalization/brazil_quarters.csv");
...
impl Default for BrazilNormalizer {
    fn default() -> Self {
        Self::new()
    }
}

impl Trainable for BrazilNormalizer {}

impl Normalizer for BrazilNormalizer {
...
mod tests {
    ...
    fn brazil_normalizer_has_correct_size() {
        let normalizer = BrazilNormalizer::new();
    ...
    fn no_panic_on_default_usage() -> BpResult<()> {
        ...
        let mut normalizer = BrazilNormalizer::new();
